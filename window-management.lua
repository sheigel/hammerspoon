...
local modalKey = hs.hotkey.modal.new(hyper, 'W')
...
modalKey:bind('shift', 'N', 'Move window to next monitor screen' , function()
...
modalKey:bind('alt', 'H', 'Resize window to left 1/3 of screen', function() push(0, 0, 0.34, 1) end)
modalKey:bind('', 'H', 'Resize window to left half of screen', function() push(0, 0, 0.5, 1) end)
modalKey:bind('shift', 'H', 'Resize window to left 2/3 of screen', function() push(0, 0, 0.66, 1) end)

modalKey:bind('alt', 'J', 'Resize window to bottom 1/3 of screen', function() push(0, 0.66, 1, 0.34) end)
modalKey:bind('', 'J', 'Resize window to bottom half of screen', function() push(0, 0.5, 1, 0.5) end)
modalKey:bind('shift', 'J', 'Resize window to bottom 2/3 of screen', function() push(0, 0.34, 1, 0.66) end)

modalKey:bind('alt', 'K', 'Resize window to top 1/3 of screen', function() push(0, 0, 1, 0.34) end)
modalKey:bind('', 'K', 'Resize window to top half of screen', function() push(0, 0, 1, 0.5) end)
modalKey:bind('shift', 'K', 'Resize window to top 2/3 of screen', function() push(0, 0, 1, 0.66) end)

modalKey:bind('alt', 'L', 'Resize window to right 1/3 of screen', function() push(0.66, 0, 0.34, 1) end)
modalKey:bind('', 'L', 'Resize window to right half of screen', function() push(0.5, 0, 0.5, 1) end)
modalKey:bind('shift', 'L', 'Resize window to right 2/3 of screen', function() push(0.34, 0, 0.66, 1) end)
